...
void loop()
{
  ...
  if (Serial1.available())
  {
    ...
    //commandbuffer[i++]='\0';
    a = atoi(commandbuffer); // converteste din arrayul commandbuffer in integer
    if (i > 0)
...
//
//      //commandbuffer[i++] = Serial1.read();
//      bluetoothRead = Serial1.read();
//      // commandbuffer[i++] = '\0';
//      //readValue = atoi((char*)commandbuffer); // converteste din arrayul commandbuffer in integer
//      //Serial.println((char*)commandbuffer);
...
//        maxValue = bluetoothRead;
//      }
//      if (readValue < minValue)
//      {
//        /*record the maximum sensor value*/
//        minValue = bluetoothRead;
//      }
//
//      // Subtract min from max
//
//      result = (bluetoothRead) * (4.50 / 1023.0); // era imultit cu 5.0
