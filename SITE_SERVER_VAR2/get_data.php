...
<div class="jumbotron" id="box-wrapper">
	...
	<div class="container">	
		<div class="page-header">
			<button type="button" class="btn btn-primary btn-block btn-lg btn-danger" data-toggle="modal" data-target="#myModal2" style = "display:none;" id = "stopRec">Stop recording</button>
		</div>
	</div>
	<div class="container">
		<div class="page-header">
			...
			<div class="modal-dialog modal-sm">
			  <div class="modal-content">
				<div class="modal-header">
				  ...
				  <h4 class="modal-title">Start Recording</h4>
				</div>
				<div class="modal-body">
				  <p>You have to set up a device name.</p>
					...
					<div class="modal-footer">
					  ...
					  <input type="submit" action = "insertCost.php" name = "send" id = "submitValue" data-dismiss="modal" value = "Submit" class="btn btn-primary">
					</div>
